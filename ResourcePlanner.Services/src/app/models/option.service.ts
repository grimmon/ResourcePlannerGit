...
export class OptionService {
    ...
    initObservableSelector(selector: string, optionType: OptionType, handler: (value: any) => void): any {
        var selectorObj: any = JQuery(selector);
