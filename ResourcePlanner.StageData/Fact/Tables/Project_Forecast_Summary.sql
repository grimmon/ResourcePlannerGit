CREATE TABLE [Fact].[Project_Forecast_Summary] (
    [Project_Forecast_Summary_Key]        INT      NOT NULL,
    ...
    [Booked_Revenue_Amount]               MONEY    NOT NULL,
    [Remaining_Forecasted_Revenue_Amount] MONEY    NOT NULL,
